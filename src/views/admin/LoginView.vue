            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 md:p-8 animate-fadeIn">
                    ...
                    <div class="w-16 h-16 bg-[#C5A028]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-[#C5A028]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 7.5a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zM12 12.75v-4.5m0 9h.008c.412 0 .75-.337.75-.75 0-.413-.338-.75-.75-.75H12m-7.5 0h15m-15 0v6m15-6v6" />
                        </svg>
                    </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input v-model="resetEmail" type="email" placeholder="tucorreo@ejemplo.com"
            ...
            <div class="p-6 md:p-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#333333]/40"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
                            </svg>
                            <input v-model="email" type="email" placeholder="tucorreo@ejemplo.com"
                ...
                <div>
                    <!-- Enlace a registro -->
                    <p class="mt-6 text-center text-sm text-[#333333]/70">
                        ¿No tienes cuenta?
                        <router-link to="/register" class="text-[#C5A028] font-semibold hover:underline">
                            Crea una cuenta
                        </router-link>
                    </p>
                </div>
