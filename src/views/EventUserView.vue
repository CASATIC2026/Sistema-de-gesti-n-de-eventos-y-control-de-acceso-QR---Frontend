...
const hasTicket = (eventId) => {
  return myTickets.value.some(t => t.event.id === eventId)
}
  ...
  <div class="min-h-screen bg-[#F5F5F5] font-['Work_Sans']">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <nav :class="['md:flex md:items-center md:gap-8', mobileMenuOpen ? 'block' : 'hidden']">
            <div class="flex flex-col md:flex-row gap-4 md:gap-6">
              ...
              <a href="#"
                class="bg-[#C5A028] text-[#121212] px-5 py-2 rounded-lg font-semibold hover:bg-[#C5A028]/90 transition shadow-lg">
                Register
              </a>
            </div>
          </nav>
    ...
    <section class="relative bg-gradient-to-br from-[#121212] to-[#1a1a1a] text-white py-20 md:py-28">
      <div class="container mx-auto px-4 md:px-6 text-center">
        <h2
          class="text-4xl md:text-6xl font-bold font-['Manrope'] mb-4 bg-gradient-to-r from-[#C5A028] to-[#C5A028]/60 bg-clip-text text-transparent">
          Curated Experiences
        </h2>
            ...
            <div class="p-6">
              ...
              <div class="flex justify-between items-center mb-4">
                ...
                <span class="px-2 py-1 rounded-full text-xs font-semibold" :class="{
                  'bg-blue-100 text-blue-700': getEventStatus(event) === 'Próximo',
                  'bg-green-100 text-green-700': getEventStatus(event) === 'En curso',
                  'bg-gray-200 text-gray-600': getEventStatus(event) === 'Finalizado'
                }">
              ...
              <div class="flex justify-between items-center">
                ...
                <button @click="handleRegister(event.id)" :disabled="loadingEventId === event.id || hasTicket(event.id)"
                  class="px-5 py-2 rounded-lg font-semibold transition shadow-md" :class="hasTicket(event.id)
    ...
    <section class="py-16 md:py-20 bg-white">
      <div class="container mx-auto px-4 md:px-6">
        ...
        <h3
          class="text-2xl md:text-3xl font-bold font-['Manrope'] text-[#333333] border-l-4 border-[#C5A028] pl-4 mb-8">
          TU COLECCIÓN
        </h3>
              ...
              <div class="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p class="font-semibold">
                    {{ new Date(ticket.event.startDateTime).toLocaleString() }}
                    -
